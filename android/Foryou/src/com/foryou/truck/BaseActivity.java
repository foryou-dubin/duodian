...
abstract class BaseActivity extends Activity implements View.OnClickListener {
	...
	public void alertDialog(String title, String des, final boolean needfinish) {
		AlertDialog.Builder adb = new AlertDialog.Builder(this,AlertDialog.THEME_HOLO_LIGHT);
		adb.setTitle(title);
		adb.setMessage(des);
	...
	public void alertDialog(String title, String des,DialogInterface.OnClickListener listener) {
		AlertDialog.Builder adb = new AlertDialog.Builder(this,AlertDialog.THEME_HOLO_LIGHT);
		adb.setTitle(title);
		adb.setMessage(des);
